Android Politique de Confidentialité du Score Détaillé (FR)
===========================================================
...
Le modèle de menace peut être consulté à l'adresse [https://github.com/edamametechnologies/threatmodels/blob/main/threatmodel-Android.json](https://github.com/edamametechnologies/threatmodels/blob/main/threatmodel-Android.json).

Le wiki du modèle de menace peut être consulté à l'adresse [https://github.com/edamametechnologies/threatmodels/wiki/threatmodel-Android-FR](https://github.com/edamametechnologies/threatmodels/wiki/threatmodel-Android-FR).
