iOS Detailed Score Privacy Policy (EN)
======================================
...
The threat model can be seen at [https://github.com/edamametechnologies/threatmodels/blob/main/threatmodel-iOS.json](https://github.com/edamametechnologies/threatmodels/blob/main/threatmodel-iOS.json).

The threat model wiki can be seen at [https://github.com/edamametechnologies/threatmodels/wiki/threatmodel-iOS-EN](https://github.com/edamametechnologies/threatmodels/wiki/threatmodel-iOS-EN).
