...
impl fmt::Display for BackendErrorCode {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            BackendErrorCode::UserDisabled => write!(f, "UserDisabled"),
            BackendErrorCode::DeviceDisabled => write!(f, "DeviceDisabled"),
            BackendErrorCode::SignatureBadVersion => write!(f, "BadSignatureVersion"),
            BackendErrorCode::InvalidToken => write!(f, "InvalidToken"),
            BackendErrorCode::UserEmailNotFound => write!(f, "UserEmailNotFound"),
            BackendErrorCode::InvalidSignature => write!(f, "InvalidSignature"),
            BackendErrorCode::InvalidPolicy => write!(f, "InvalidPolicy"),
            BackendErrorCode::LimitReached => write!(f, "LimitReached"),
            BackendErrorCode::AiProviderError => write!(f, "AiProviderError"),
            BackendErrorCode::GraceBlocked => write!(f, "GraceBlocked"),
